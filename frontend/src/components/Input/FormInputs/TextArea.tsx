...
import type { DetailedHTMLProps, HTMLInputTypeAttribute, InputHTMLAttributes, Ref } from 'react';
...
export const FormTextArea = forwardRef(function FormTextArea(
  { label, name, id, placeholder, classInput, classLabel, ...other }: FormTextAreaProps,
